...
def buy(quantidade):
    ...
    payment_amount = web3.to_wei(tier3.price * quantidade, 'ether')
    to_address = web3.to_checksum_address(tier3.contract_address)
    contract = web3.eth.contract(address=to_address, abi=tier3.abi)
