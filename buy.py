...
def buy(quantidade):
    ...
    payment_amount = web3.to_wei(tier1.price * quantidade, 'ether')
    to_address = web3.to_checksum_address(tier1.contract_address)
    contract = web3.eth.contract(address=to_address, abi=tier1.abi)
